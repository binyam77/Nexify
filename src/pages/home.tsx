      ...
      {posts.length > 1 && (
        <div className="hidden md:flex fixed right-8 top-1/2 -translate-y-1/2 flex-col gap-3 z-50">
          ...
          <button onClick={goNext} disabled={currentIndex === posts.length - 1}
            className="w-10 h-10 rounded-full bg-blue-600 hover:bg-blue-700 shadow-lg flex items-center justify-center text-white disabled:opacity-30 transition-all">
